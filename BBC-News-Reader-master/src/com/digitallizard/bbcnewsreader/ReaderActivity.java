...
public class ReaderActivity extends Activity {
	...
	PullToRefreshHorizontalScrollView mPullRefreshScrollView1;
	HorizontalScrollView mScrollView1;
	
	/* constants */
	static final int ACTIVITY_CHOOSE_CATEGORIES = 1;
	static final int CATEGORY_ROW_LENGTH = 10;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPullRefreshScrollView1 = (PullToRefreshHorizontalScrollView) findViewById(R.id.h2);
		mPullRefreshScrollView1.setOnRefreshListener(new OnRefreshListener<HorizontalScrollView>() {
		...
		mScrollView1 = mPullRefreshScrollView1.getRefreshableView();
        
    	mPullRefreshScrollView = (PullToRefreshScrollView) findViewById(R.id.newsScroller);
	...
	private class GetDataTask1 extends AsyncTask<Void, Void, String[]> {
		...
		protected void onPostExecute(String[] result1) {
			...
			mPullRefreshScrollView1.onRefreshComplete();
